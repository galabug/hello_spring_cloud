...
public class ConsumerClusterB {
    private  static final Logger LOGGER = LoggerFactory.getLogger(ConsumerClusterB.class);

//    public static void main(String[] args) throws InterruptedException, MQClientException {
//        startConsumerB();
//    }

    private static void startConsumerB() throws MQClientException {
